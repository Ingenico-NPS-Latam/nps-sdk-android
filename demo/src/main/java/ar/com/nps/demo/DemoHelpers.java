...
public class DemoHelpers {
    ...
    public static String CreateCustomer(String environment, String psp_MerchantId, String secretCode) {
        try {
            ...
            String psp_SecureHash = DemoHelpers.calculateMD5(Requerimiento.getProperty("psp_Version") + "" + Requerimiento.getProperty("psp_MerchantId") + "" + Requerimiento.getProperty("psp_EmailAddress") + "" + Requerimiento.getProperty("psp_PosDateTime") + "" + secretCode);
